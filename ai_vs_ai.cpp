...
int main()
{
    ...
    while(t)
    {
        ...
        bool chance = toss();
        if(chance)
            cout<<"AI1 won the toss\n\n";
        else
            cout<<"AI2 won the toss\n\n";
        ...
        if(!chance)
        {
            ...
            cout<<"\nAI2 picked up "<<pick<<" sticks\n";
            n = n - pick;
            cout<<"remaining sticks are "<<n<<"\n\n";
            if(n == 0)
            {
                cout<<"\n\n-------------AI1 lost, AI2 won....CONGRATULATIONS----------------\n\n\n\n";
                break;
            }
        }
        ...
        while(n)
        {
            chance = !chance;
            int x = minimax(n, chance);
            cout<<"\nAI1 picked up "<<pick<<" sticks\n";
            n = n - pick;
            cout<<"remaining sticks are "<<n<<"\n\n";

            if(n == 0)
            {
                cout<<"\n\n-------------AI2 lost, AI1 won....CONGRATULATIONS----------------\n\n\n\n";
                break;
            }
            chance = !chance;
            x = minimax(n, chance);
